...
@Component({
  selector: 'app-move-photos-dialog',
  imports: [
    CommonModule,
    MatFormField,
    MatList,
  ...
  templateUrl: './move-photos-dialog.component.html',
  styleUrl: './move-photos-dialog.component.scss'
})
export class MovePhotosDialogComponent {
  domains: any[] = [];
  filteredDomains: any[] = [];
  searchQuery = '';
  ...
  dialogRef = inject<MatDialogRef<MovePhotosDialogComponent>>(MatDialogRef);
